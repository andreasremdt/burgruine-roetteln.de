...
export default function OneColumnWithImage({ content, image, buttons }: OneColumnWithImageBlock) {
  return (
    <section className="bg-primary-50 before:bg-primary-50 relative pb-24 before:absolute before:right-0 before:bottom-0 before:left-0 before:h-20 xl:pb-0 xl:before:bg-white">
